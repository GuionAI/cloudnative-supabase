...
KIND_CLUSTER ?= cloudnative-supabase-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name cloudnative-supabase-builder
	$(CONTAINER_TOOL) buildx use cloudnative-supabase-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm cloudnative-supabase-builder
	rm Dockerfile.cross
